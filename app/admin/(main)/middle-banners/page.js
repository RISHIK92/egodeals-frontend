...
export default function BannerManagementPage() {
  ...
  const bannerType = "middle-banners";
    ...
    const fetchBanners = async () => {
      try {
        const response = await axios.get(
          `${process.env.NEXT_PUBLIC_BACKEND_URL_ADMIN}/middle-banners`,
          {}
        );
    ...
    try {
      ...
      if (mediaType === "image" && selectedFile) {
        ...
        const uploadResponse = await axios.post(
          `${process.env.NEXT_PUBLIC_BACKEND_URL_ADMIN}/middle-banners/upload`,
          uploadFormData,
          {
            headers: {
      ...
      if (editingId) {
        ...
        await axios.put(
          `${process.env.NEXT_PUBLIC_BACKEND_URL_ADMIN}/middle-banners/${editingId}`,
          bannerData,
          {
            withCredentials: true,
          }
  ...
  const handleDelete = async (id) => {
    ...
    try {
      await axios.delete(
        `${process.env.NEXT_PUBLIC_BACKEND_URL_ADMIN}/middle-banners/${id}`,
        { withCredentials: true }
      );
